...
preprocessor = ColumnTransformer(
    transformers = [
        ("encoder", OneHotEncoder(), categorical_features),("scaler",MinMaxScaler(),numerical_features)
    ],
...
#  'logistic_regression__penalty': ['l2',None,'l1','elasticnet'],
#         'logistic_regression__tol': [0.000001,0.1,0.001],
#         'logistic_regression__C': [0.05,0.0005,0.1,1,2],
#         'logistic_regression__random_state': [42500],
#         'logistic_regression__solver': ['newton-cholesky',"lbfgs",'liblinear'],
#         'logistic_regression__max_iter': [100,200,500,1000,2000,5000],
...
def optimize(pipeline,x_train,y_train,x_test,y_test):
    param_grid = {
        ...
        # 'logistic_regression__penalty': ['l2',None,'l1','elasticnet'],
        # 'logistic_regression__dual':[True,False],
        # 'logistic_regression__tol': [0.1,0.0001,0.000001],
        # 'logistic_regression__C': [0.05,0.005,1,5],
        # 'logistic_regression__fit_intercept': [True,False],
        # 'logistic_regression__random_state': [42500],
        # 'logistic_regression__solver': ["lbfgs",'newton-cholesky','newton-cg'],
        # 'logistic_regression__max_iter': [50,100,1000],
        # 'select_kbest__k':[17,10,20,24],
        ...
        # 'logistic_regression__tol': [0.03],
        'logistic_regression__C': [0.7,0.9],
        # 'logistic_regression__fit_intercept': [False],
        # 'logistic_regression__class_weight': [{0: 1, 1: 1.2668}],
        'logistic_regression__random_state': [42500],
